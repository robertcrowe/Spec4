...
from spec4.agents._stack_context import phases_for_deployer
...
def test_build_order_lists_every_phase_with_its_path() -> None:
    ...
    out = phases_for_deployer(phases, 2)
    for n in (1, 2, 3):
...
def test_phase_count_is_stated() -> None:
    out = phases_for_deployer([_phase(1), _phase(2)], 0)
